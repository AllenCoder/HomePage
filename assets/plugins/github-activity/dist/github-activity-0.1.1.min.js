...
var GitHubActivity = function () {
    ...
    return a.feed = function (a) {
        ...
        if ("object" == typeof a.templates)for (var i in templates)"string" == typeof a.templates[i] && (templates[i] = a.templates[i]);
        ...
        } else c = Mustache.render(templates.NotFound, {username: a.username});
        if (d = "#" === e.charAt(0) ? document.getElementById(e.substring(1)) : document.getElementsByClassName(e.substring(1)), d instanceof HTMLCollection)for (var k = 0; k < d.length; k++)b.renderStream(c, d[k]); else b.renderStream(c, d)
    }, a
